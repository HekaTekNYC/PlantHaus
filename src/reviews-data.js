    ...
    people: [
      {
        ...
        location: '',
        review:
          'I am delighted with my experience. The plant arrived in excellent condition, well-packaged, and the selection on the website made it easy to find the perfect green companion for my home.',
      },
      {
        id: 2,
        imageUrl: 'https://i.ibb.co/GT7Y7W6/eyebrows-chick.png',
        rating: '',
        name: 'Eyebrow Chick',
      ...
      {
        id: 4,
        imageUrl: 'https://i.ibb.co/7zW61Sy/Hot-Man.png',
        rating: '',
        name: 'Hot Guy',
      ...
      {
        id: 5,
        imageUrl: 'https://i.ibb.co/z6gtk3c/normal-chick.png',
        rating: '',
        user: 'Normal Chick',
