  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        size_description: {
          small:
            'Small: Typically ranging from 6" to 9" in height, showcasing intricate details and refined shaping.',
          medium:
            'Medium: Varies between 10" to 17" tall, presenting a mature and harmonious aesthetic.',
        },
        pro_tip:
    ...
    items: [
      {
        ...
        size_description: {
          ...
          medium:
            'Medium: Reaching 6"–12" in diameter with a more established and mature appearance.',
        },
        pro_tip:
      ...
      },
      {
        ...
        size_description: {
          ...
          large: 'Large: Majestic at 24"–36" tall in a 10-inch pot.',
          extra_large:
            'Extra Large: Towering at 36"–60" in height, making a bold statement in a 12-inch pot.',
        },
        pro_tip:
  ...
  },
  {
    ...
    items: [
...

      {
        ...
        latin_biomial: "Chlorophytum comosum 'Variegatum'",
        imageUrl: {
          img1: 'https://i.ibb.co/jZFzYtm/spider-plant-2.png',
          img2: 'https://i.ibb.co/sypmCwF/spider-plant-3.png',
          img3: 'https://i.ibb.co/QH5VV6k/spider-plant-4.png',
        },
        thumbnailUrl: {
          thumb1: 'https://i.ibb.co/kJ5W4xf/spider-plant-2-thumb.png',
          thumb2: 'https://i.ibb.co/2Wg9TBb/spider-plant-3-thumb.png',
          thumb3: 'https://i.ibb.co/wQ6MZGn/spider-plant-4-thumb.png',
        },
        price: {
          small: 22,
          medium: 32,
      ...
      },
      {
        ...
        latin_biomial: 'Beaucarnea recurvata',
        imageUrl: {
          img1:'https://i.ibb.co/rZr1c1J/ponytail-palm-1.png' ,
          img2:'https://i.ibb.co/ZNJcQcG/ponytail-palm-2.png',
          img3:'https://i.ibb.co/mJCQfC3/ponytail-palm-3.png',
        },
        thumbnailUrl: {
          thumb1: 'https://i.ibb.co/3T00kBp/ponytail-palm-1-thumb.png',
          thumb2: 'https://i.ibb.co/rmbWYK5/ponytail-palm-2-thumb-2.png',
      ...
      },
      {
        ...
        latin_biomial: 'Juniperus spp. (Various species)',
        imageUrl: {
          img1: 'https://i.ibb.co/3F3Vb6B/bonsai-1.png',
          img2: 'https://i.ibb.co/LhXvLsd/bonsai-2.png',
          img3: 'https://i.ibb.co/f9VpNbw/bonsai-3.png',
        },
        thumbnailUrl: {
          thumb1: 'https://i.ibb.co/Gn9YqwY/bonsai-1-thumb.png',
          thumb2: 'https://i.ibb.co/nMH0vvT/bonsai-2-thumb.png',
      ...
      },
      {
        ...
        latin_biomial: 'Monstera deliciosa',
        imageUrl: {
          img1: 'https://i.ibb.co/YLZ8zV4/monstera-1.png',
          img2: 'https://i.ibb.co/LhJWndS/monstera-2.png',
          img3: 'https://i.ibb.co/9rwhh2G/monstera-3.png',
          img4:  'https://i.ibb.co/KwDBbrH/monstera-4.png',
        },
        thumbnailUrl: {
      ...
      },
      {
        ...
        imageUrl: {
          ...
          img2: 'https://i.ibb.co/CWYDYS9/satin-pothos-2.png',
          img3: 'https://i.ibb.co/G20Bn1n/satin-pothos-3.png',
          img4: 'https://i.ibb.co/gz6qkbs/satin-pothos-4.png',
        },
        thumbnailUrl: {
          thumb3: 'https://i.ibb.co/qyg7f8M/satin-pothos-1-thumb.png',
          thumb1: 'https://i.ibb.co/4sx2JPm/satin-pothos-2-thumb.png',
      ...
      },
      {
        ...
        latin_biomial: 'Yucca elephantipes',
        imageUrl: {
          img1: 'https://i.ibb.co/bBDcxSB/Yucca-cane-1.png',
          img2: 'https://i.ibb.co/sR5RHwc/yuca-cane-2.png',

        },
        thumbnailUrl: {
          thumb1: 'https://i.ibb.co/cxfj7BT/Yucca-cane-1-thumb.png',
          thumb2: 'https://i.ibb.co/YXphHq8/yuca-cane-3-thumb-2.png',
        },
        price: {
          small: 22,
          medium: 32,
      ...
      },
      {
        ...
        latin_biomial: 'Echeveria spp.',
        imageUrl: {
          img1: 'https://i.ibb.co/Db0ty6W/echeveria-1.png',
          img2: 'https://i.ibb.co/cFGHJrk/echeveria-2.png',
          img3: 'https://i.ibb.co/VLLgxG7/Echeveria-3.png"',
        },
        thumbnailUrl: {
          thumb1: 'https://i.ibb.co/V3BcQqJ/echeveria-1-thumb.png',
          thumb2: 'https://i.ibb.co/fGJySyq/echeveria-2-thumb.png',
          thumb3: 'https://i.ibb.co/jZkY3zX/Echeveria-3-thumb.png',
        },
      ...
      },
      {
        ...
        latin_biomial: 'Sansevieria trifasciata',
        imageUrl: {
          img1: 'https://i.ibb.co/F530ZDJ/snake-plant-1',
          img2: 'https://i.ibb.co/tYv4RHY/snake-plant-2',
          img3: 'https://i.ibb.co/VwYysjQ/snake-plant-3',
        },
        thumbnailUrl: {
          thumb1: 'https://i.ibb.co/CKx2LpQ/snake-plant-1-thumb.png',
          thumb2: 'https://i.ibb.co/1Kp20hf/snake-plant-2-thumb.png',
          thumb3: 'https://i.ibb.co/KxfSY9T/snake-plant-3-thumb.png',
        },
        price: {
          small: 22,
          medium: 32,
      ...
      },
      {
        ...
        latin_biomial: "Epipremnum aureum 'Marble Queen' or 'Golden Pothos'",
        imageUrl: {
          img1: 'https://i.ibb.co/5T7ZYQC/pothos-verigated-1.png',
          img2: 'https://i.ibb.co/KsZJ2XC/pothos-verigated-2.png',
        },
        thumbnailUrl: {
          thumb1: 'https://i.ibb.co/7Yxd0r1/pothos-verigated-1-thumb.png',
          thumb2: 'https://i.ibb.co/VYw1MHX/pothos-verigated-2-thumb.png',
        },
        price: {
          small: 22,
          medium: 32,
      ...
      },
      {
        ...
        latin_biomial: 'Ficus lyrata',
        imageUrl: {
          img1: 'https://i.ibb.co/v4HmSLj/fiddle-leaf-fig-1.png ',
          img2: 'https://i.ibb.co/0G1XHRc/fiddle-leaf-fig-2.png',
          img3: 'https://i.ibb.co/7nG1zX7/fiddle-leaf-fig-3.png',
        },
        thumbnailUrl: {
          thumb1: 'https://i.ibb.co/C9M5L0t/fiddle-leaf-fig-1-thumb.png',
          thumb2: 'https://i.ibb.co/QbVPhkC/fiddle-leaf-fig-2-thumb.png',
          thumb3: 'https://i.ibb.co/Sx5dvz3/fiddle-leaf-fig-3-thumb.png',
        },
        price: {
          small: 22,
          medium: 32,
